                    ...
                    {payments.map((payment) => (
                      <tr key={payment._id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="text-xs text-gray-500">
                            {payment.type === 'ticket_booking' 
                              ? (payment.bookingDetails?.numberOfTickets && payment.amount / payment.bookingDetails.numberOfTickets === 149 
                                  ? 'Couple Ticket @ ₹149 each' 
                                  : 'Show Ticket @ ₹99 each')
                              : payment.type}
                          </div>
                        </td>
                        ...
                        <tr key={booking._id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-medium text-purple-600">
                              Quantity: {booking.numberOfTickets || 0}
                            </div>
                            <div className="text-sm font-medium text-gray-900">
                              Total Amount: ₹{(booking.numberOfTickets || 0) * (booking.pricePerTicket || 0)}
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            {booking.ticketType === 'couple' ? 'Couple Ticket' : 'Normal Ticket'}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
